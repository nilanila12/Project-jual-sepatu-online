...
$jumlahData = count(query("SELECT * FROM tbl_barang WHERE nama LIKE '%sepatu%'"));
...
$t_barang = query("SELECT * FROM tbl_barang WHERE nama LIKE '%sepatu%' LIMIT $awalData, $jumlahDataPerHalaman");
          ...
          ?>
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                    	<a href="#pageSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-fw fa-female"></i>Sepatu<i class="fa fa-fw fa-caret-down"></i></a>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading"><h3>Sepatu</h3></div>

							<div class="panel-body">
								<center><h2 style="color: red;">Produk Sepatu</h2></center><br>
